...
# 📊 Comparação de Receitas Fixas e Variáveis
st.subheader("📊 Comparação de Receitas Fixas e Variáveis")

# Filtra as receitas fixas e variáveis
fixas_receitas = receitas[receitas['Categoria_Receita'] == 'Fixa']
variaveis_receitas = receitas[receitas['Categoria_Receita'] == 'Variável']

# Soma os valores das receitas fixas e variáveis
total_fixas_receitas = fixas_receitas['Valor_Receita'].sum()
total_variaveis_receitas = variaveis_receitas['Valor_Receita'].sum()

# Gráfico de barras para comparar as receitas fixas e variáveis
fig_receitas, ax_receitas = plt.subplots()
...
# 📊 Comparação de Despesas Fixas e Variáveis
st.subheader("📊 Comparação de Despesas Fixas e Variáveis")

# Filtra as despesas fixas e variáveis
fixas_despesas = despesas[despesas['Categoria_Despesa'] == 'Fixa']
variaveis_despesas = despesas[despesas['Categoria_Despesa'] == 'Variável']

# Soma os valores das despesas fixas e variáveis
total_fixas_despesas = fixas_despesas['Valor_Despesa'].sum()
total_variaveis_despesas = variaveis_despesas['Valor_Despesa'].sum()

# Gráfico de barras para comparar as despesas fixas e variáveis
fig_despesas, ax_despesas = plt.subplots()
